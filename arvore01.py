...
class BinarySearchTree:
    ...
    def insert(self, label):
        ...
        if self.empty():
            self.root = node #se tiver vazia, o no inserido é a raiz
        else:
            #arvore não vazia, insere recursivamente
            dad_node = None
            curr_node = self.root # percorrer começa da raíz
            ...
            while True:
                if curr_node != None:
                    ...
                    # se curr_node é None, encontrou onde inserir
